...
import { BreadcrumbSchema } from "@/components/shared/seo/StructuredData";
...
export default function SearchPage() {
  ...
  return (
    <>
      <Head>
        <title>Search Results | Codemantix Collective</title>
        <meta
          name="description"
          content="Find what you're looking for on Codemantix Collective - web development, UI/UX design, and data analysis services."
        />
      </Head>
